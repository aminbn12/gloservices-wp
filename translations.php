...
function gloservices_get_translations($lang = 'fr') {
    $all = array(
        ...
        'Nos partenaires s\'appuient sur notre expertise technique pour concrétiser leurs idées. Ensemble, nous formons une équipe soudée, engagée dans la réussite de chaque chantier. Découvrez ceux qui choisissent de travailler avec nous !' => array(
            'en' => 'Our partners rely on our technical expertise to make their ideas a reality. Together, we form a cohesive team dedicated to the success of every site. Discover those who choose to work with us!',
            'ar' => 'يعتمد شركاؤنا على خبرتنا الفنية لتحقيق أفكارهم. معاً، نُشكل فريقاً متماسكاً مكرساً لنجاح كل مشروع. اكتشف من يختارون العمل معنا!'
        ),
        ...
        'Ajouter un plan ou document (Optionnel - PDF, JPG, PNG - Max 5 Mo)' => array('en' => 'Add a layout or document (Optional - PDF, JPG, PNG - Max 5MB)', 'ar' => 'إضافة مخطط أو وثيقة (اختياري - PDF, JPG, PNG - حد أقصى 5 ميغابايت)'),
        'Ajouter des plans ou documents (Optionnel - Max 4 fichiers, PDF/JPG/PNG, Max 20 Mo au total)' => array('en' => 'Add plans or documents (Optional - Max 4 files, PDF/JPG/PNG, Max 20MB total)', 'ar' => 'إضافة مخططات أو مستندات (اختياري - 4 ملفات كحد أقصى، PDF/JPG/PNG، 20 ميغابايت إجمالاً)'),
        'Vous ne pouvez pas télécharger plus de 4 fichiers.' => array('en' => 'You cannot upload more than 4 files.', 'ar' => 'لا يمكنك تحميل أكثر من 4 ملفات.'),
        'La taille totale des fichiers dépasse 20 Mo.' => array('en' => 'Total file size exceeds 20MB.', 'ar' => 'الحجم الإجمالي للملفات يتجاوز 20 ميغابايت.'),
        'Choisir un fichier' => array('en' => 'Choose a file', 'ar' => 'اختيار ملف'),
        'Ajouter un fichier' => array('en' => 'Add a file', 'ar' => 'إضافة ملف'),
        'Aucun fichier choisi' => array('en' => 'No file chosen', 'ar' => 'لم يتم اختيار أي ملف'),
        ...
        'Détails du Service' => array('en' => 'Service Details', 'ar' => 'تفاصيل الخدمة'),
        'Informations & Accompagnement' => array('en' => 'Information & Support', 'ar' => 'المعلومات والدعم'),
        'Nos ingénieurs experts vous accompagnent de la conception préliminaire jusqu\'à la livraison sur chantier.' => array('en' => 'Our expert engineers support you from preliminary design to delivery on site.', 'ar' => 'يرافقكم مهندسونا الخبراء من التصميم الأولي وحتى التسليم في الموقع.'),
        'Normes Certifiées' => array('en' => 'Certified Standards', 'ar' => 'المعايير المعتمدة'),
        'Logiciels sous licence' => array('en' => 'Licensed Software', 'ar' => 'برمجيات مرخصة'),
        'Suivi de Chantier' => array('en' => 'Site Supervision', 'ar' => 'متابعة ورش العمل'),
        'RPS 2000, NM & Eurocodes' => array('en' => 'RPS 2000, NM & Eurocodes', 'ar' => 'RPS 2000، NM و Eurocodes'),
        'Robot, Covadis, Revit 3D' => array('en' => 'Robot, Covadis, Revit 3D', 'ar' => 'Robot، Covadis، Revit 3D'),
        'Contrôle qualité & Maîtrise d\'ouvrage' => array('en' => 'Quality Control & Project Management', 'ar' => 'مراقبة الجودة وإدارة المشاريع'),
        'Demander un devis gratuit' => array('en' => 'Request a free quote', 'ar' => 'طلب عرض سعر مجاني'),
        'Retour aux services' => array('en' => 'Back to services', 'ar' => 'العودة إلى الخدمات'),
        ...
        '11 Rue Dayat Aoua, Rabat 10000, Maroc' => array('en' => '11 Dayat Aoua St, Rabat 10000, Morocco', 'ar' => '11 شارع ضاية عوا، الرباط 10000، المغرب'),
        ...
        'Lundi - Vendredi : 09h00 - 17h00' => array('en' => 'Monday - Friday: 09:00 AM - 05:00 PM', 'ar' => 'الإثنين - الجمعة: 09:00 - 17:00'),
        ...
        // ===== FORM SUBMISSIONS & ALERTS =====
        'Message envoyé !' => array('en' => 'Message sent!', 'ar' => 'تم إرسال الرسالة!'),
        'Votre message a bien été transmis. Notre équipe vous contactera dans les plus brefs délais.' => array('en' => 'Your message has been sent successfully. Our team will contact you as soon as possible.', 'ar' => 'تم إرسال رسالتكم بنجاح. سيتصل بكم فريقنا في أقرب وقت ممكن.'),
        'Demande de devis transmise !' => array('en' => 'Quote request sent!', 'ar' => 'تم إرسال طلب الاقتباس!'),
        'Nous analysons votre demande et vous répondrons sous 24h.' => array('en' => 'We are analyzing your request and will respond within 24 hours.', 'ar' => 'نحن نحلل طلبكم وسنجيبكم في غضون 24 ساعة.'),
        'Veuillez remplir tous les champs obligatoires.' => array('en' => 'Please fill in all required fields.', 'ar' => 'يرجى ملء جميع الحقول المطلوبة.'),
        'L\'adresse e-mail saisie n\'est pas valide.' => array('en' => 'The email address entered is not valid.', 'ar' => 'البريد الإلكتروني الذي تم إدخاله غير صالح.'),
        'Session expirée ou erreur de sécurité. Veuillez réessayer.' => array('en' => 'Session expired or security error. Please try again.', 'ar' => 'انتهت الجلسة أو حدث خطأ أمني. يرجى المحاولة مرة أخرى.'),
        'Veuillez renseigner toutes les informations requises.' => array('en' => 'Please provide all required information.', 'ar' => 'يرجى تقديم جميع المعلومات المطلوبة.'),
        'Veuillez saisir une adresse e-mail valide.' => array('en' => 'Please enter a valid email address.', 'ar' => 'يرجى إدخال بريد إلكتروني صالح.'),
        'Le fichier joint est trop volumineux. La taille maximale est de 5 Mo.' => array('en' => 'The attached file is too large. The maximum size is 5MB.', 'ar' => 'الملف المرفق كبير جداً. الحد الأقصى للحجم هو 5 ميغابايت.'),
        'Format de fichier non valide. Seuls les formats PDF, JPG, JPEG et PNG sont acceptés.' => array('en' => 'Invalid file format. Only PDF, JPG, JPEG and PNG formats are accepted.', 'ar' => 'صيغة الملف غير صالحة. تقبل فقط صيغ PDF و JPG و JPEG و PNG.'),
        'Erreur lors du téléchargement du fichier. Veuillez réessayer.' => array('en' => 'Error uploading file. Please try again.', 'ar' => 'حدث خطأ أثناء تحميل الملف. يرجى المحاولة مرة أخرى.'),
        'Une erreur est survenue lors de l\'envoi de votre message.' => array('en' => 'An error occurred while sending your message.', 'ar' => 'حدث خطأ أثناء إرسال رسالتكم.'),
        'Une erreur est survenue lors de l\'envoi de votre demande.' => array('en' => 'An error occurred while sending your request.', 'ar' => 'حدث خطأ أثناء إرسال طلبكم.'),
        'Ajouter un plan ou document (Optionnel - PDF, JPG, PNG - Max 5 Mo)' => array('en' => 'Add a layout or document (Optional - PDF, JPG, PNG - Max 5MB)', 'ar' => 'إضافة مخطط أو وثيقة (اختياري - PDF, JPG, PNG - حد أقصى 5 ميغابايت)'),
