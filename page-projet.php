...
<div class="partners-grid-section py-5 wow fadeInUp" data-wow-delay="0.1s">
    ...
    <div class="container py-4">
        ...
        <div class="globuild-partners-orbit-container">
            ...
            <a href="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/favicon-circle.png" data-lightbox="partners-gallery" data-title="GLOBUILD" class="globuild-orbit-center-link">
            ...
            <div class="globuild-orbit-nodes">
                ...
                ?>
                    <div class="orbit-partner-node" style="--index: <?php echo $index; ?>; --total: <?php echo $total; ?>;">
                        <a href="<?php echo esc_url($img_url); ?>" data-lightbox="partners-gallery" data-title="<?php echo esc_attr($partner['name']); ?>" class="orbit-partner-link">
