...
function gloservices_scripts()
{
    ...
    // Theme main JS
    wp_enqueue_script('gloservices-main', $theme_dir . '/assets/js/main.js', ['jquery', 'lenis'], '3.1.0', true);
...
/**
 * Architectural CAD Vector Drawing Generator for Services
 */
if (!function_exists('gloservices_get_service_drawing')) {
    function gloservices_get_service_drawing($slug) {
        ...
        switch ($clean_slug) {
            ...
            case 'infrastructures-routieres-et-ponts':
                ...
                $drawing = '
                    ...
                    <g class="tech-annotation">
                        ...
                        <text x="100" y="118" fill="#FFFFFF" font-size="8" font-family="monospace" font-weight="600" text-anchor="middle">L = 145.00m</text>
                        <text x="49" y="32" fill="#FFFFFF" font-size="7" font-family="monospace" font-weight="600">H = 32.5m</text>
                    </g>
                ';
                break;
                
            case 'ouvrages-dart':
            case 'ouvrages-d-art-et-genie-civil':
                // Pont en arc / Tunnel
                $drawing = '
                    <!-- Foundation supports -->
                    ...
                    <!-- Annotations -->
                    <g class="tech-annotation">
                        <line x1="100" y1="105" x2="60" y2="65" stroke="#FFFFFF" stroke-width="0.75" stroke-dasharray="2 2" />
                        <circle cx="100" cy="105" r="2" fill="#10B981" />
                        <path d="M63,65 L60,65 L60,68" stroke="#FFFFFF" stroke-width="0.75" fill="none" />
                        <text x="80" y="85" fill="#FFFFFF" font-size="8" font-family="monospace" font-weight="600" transform="rotate(-45 80 85)">R = 45.0m</text>
                        <text x="105" y="38" fill="#FFFFFF" font-size="7" font-family="monospace" font-weight="600">CL = 100%</text>
                    </g>
                ';
                break;
                
            case 'batiments':
            case 'batiments-et-structures-complexes':
                ...
                $drawing = '
                    ...
                    <g class="tech-annotation">
                        ...
                        <text x="12" y="33" fill="#FFFFFF" font-size="7" font-family="monospace" font-weight="600">N3:+9.00</text>
                        
                        <path d="M35,60 L40,60 L37.5,56 Z" fill="#10B981" />
                        <text x="12" y="63" fill="#FFFFFF" font-size="7" font-family="monospace" font-weight="600">N2:+6.00</text>
                        
                        <path d="M35,90 L40,90 L37.5,86 Z" fill="#10B981" />
                        <text x="12" y="93" fill="#FFFFFF" font-size="7" font-family="monospace" font-weight="600">N1:+3.00</text>
                        
                        <circle cx="50" cy="132" r="5" stroke="#10B981" stroke-width="0.75" fill="none" />
                        <text x="50" y="134.5" fill="#FFFFFF" font-size="6" font-family="monospace" font-weight="600" text-anchor="middle">A</text>
                        
                        <circle cx="100" cy="132" r="5" stroke="#10B981" stroke-width="0.75" fill="none" />
                        <text x="100" y="134.5" fill="#FFFFFF" font-size="6" font-family="monospace" font-weight="600" text-anchor="middle">B</text>
                        
                        <circle cx="150" cy="132" r="5" stroke="#10B981" stroke-width="0.75" fill="none" />
                        <text x="150" y="134.5" fill="#FFFFFF" font-size="6" font-family="monospace" font-weight="600" text-anchor="middle">C</text>
                    </g>
                ';
                break;
                
            case 'voirie-reseaux-divers':
            case 'voirie-et-reseaux-divers-vrd':
                ...
                $drawing = '
                    ...
                    <g class="tech-annotation">
                        ...
                        <text x="70" y="117" fill="#FFFFFF" font-size="7" font-family="monospace" font-weight="600" text-anchor="middle">EP Ø400 i=0.5%</text>
                        <text x="120" y="103" fill="#FFFFFF" font-size="7" font-family="monospace" font-weight="600" text-anchor="middle">EU Ø200</text>
                        <text x="160" y="66" fill="#FFFFFF" font-size="6" font-family="monospace" font-weight="600">ELEC</text>
                    </g>
                ';
                break;
                
            case 'solutions-digitales':
            case 'solutions-digitales-et-modelisation-bim':
                ...
                $drawing = '
                    ...
                    <g class="tech-annotation">
                        ...
                        <text x="10" y="20" fill="#FFFFFF" font-size="6" font-family="monospace" font-weight="600">BIM-MOD</text>
                        
                        <text x="145" y="30" fill="#FFFFFF" font-size="6" font-family="monospace" font-weight="600">X: 124.0</text>
                        <text x="145" y="38" fill="#FFFFFF" font-size="6" font-family="monospace" font-weight="600">Y: 285.5</text>
                        <text x="145" y="46" fill="#FFFFFF" font-size="6" font-family="monospace" font-weight="600">Z:  98.1</text>
                    </g>
                ';
                break;
                
            case 'gestion-de-projet-opc':
            case 'maitrise-d-ouvrage-et-gestion-opc':
                // Planning Gantt
                $drawing = '
                    <!-- Gantt Rows -->
                    ...
                    <g class="tech-annotation">
                        ...
                        <text x="100" y="27" fill="#FFFFFF" font-size="7" font-family="monospace" font-weight="600">J45: Valide</text>
                        
                        <text x="30" y="12" fill="#FFFFFF" font-size="7" font-family="monospace" font-weight="600">W1</text>
                        <text x="80" y="12" fill="#FFFFFF" font-size="7" font-family="monospace" font-weight="600">W2</text>
                        <text x="140" y="12" fill="#FFFFFF" font-size="7" font-family="monospace" font-weight="600">W3</text>
                    </g>
                ';
                break;
            ...
            default:
                ...
                $drawing = '
                    ...
                    <g class="tech-annotation">
                        ...
                        <text x="130" y="45" fill="#ffffff" font-size="7" font-family="monospace" font-weight="600">S2</text>
                        <text x="130" y="95" fill="#ffffff" font-size="7" font-family="monospace" font-weight="600">S3</text>
